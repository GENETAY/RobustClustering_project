...
class SMM(sklearn.base.BaseEstimator):
    ...
    init_center_given: 2dnumpy array, compulsary, no default,
                    intial mean vector in algorithm.
                    The argument is not available in the sklearn version of SMM.
                    We did it ourselves to be able to initialize it with a robust
                    method. sklearn does it with KMEANS.
    ...
    def __init__(self, init_center_given,n_components=1, covariance_type='full', 
